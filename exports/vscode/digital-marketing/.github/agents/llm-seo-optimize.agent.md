...
description: >
  ...
  Use when prose or markup needs answer-engine (AEO) treatment, whether spawned by /llm-seo-audit
  or asked for directly.
  Not for traditional organic-ranking SEO (use seo-specialist), or content marketing tone and
  voice (use content-marketer).
user-invocable: true
agents: []
---
