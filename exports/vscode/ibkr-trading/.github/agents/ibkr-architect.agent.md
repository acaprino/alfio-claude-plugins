...
name: ibkr-architect
description: >
  Expert in Interactive Brokers algotrading system design, implementation, and debugging with TWS
  API 10.45 and ib_async. Covers connection architecture, market data subscriptions, order
  execution with bracket orders, historical data pacing, reconnection resilience, IBC automation,
  and Windows production deployment. Use when building, implementing, writing, coding, or creating
  IB trading bots, connecting to TWS/IB Gateway, implementing market data subscriptions, designing
  order execution logic, handling IB reconnection, debugging TWS API errors, deploying IB trading
