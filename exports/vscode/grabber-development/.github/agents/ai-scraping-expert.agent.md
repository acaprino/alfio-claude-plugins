...
<!-- Vendored from plugins/grabber-development/agents/ai-scraping-expert.md in acaprino/claude-code-daodan, MIT. -->
...
- Async pipelines in Python -> `async-python-patterns` in the `python-development` bundle
- Tracing scraper flows -> `opentelemetry` in the `opentelemetry` bundle
