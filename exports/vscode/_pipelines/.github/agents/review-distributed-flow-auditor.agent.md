...
- Search for generated client stubs and server implementations
...
- Missing timeout on any HTTP/gRPC call (Search for HTTP calls without explicit timeout parameter)
