...
| API surface size and contract drift | `review-api-contract-auditor`, `review-cleanup-auditor` D4 for barrel and unused-export bloat | May appear incidentally inside a D7 remediation. Never a category. |
...
- **Dead code, unused exports, orphan assets, VCS hygiene**: `review-cleanup-auditor`. A duplicated representation that is simply unused is a cleanup finding, not a D3.
