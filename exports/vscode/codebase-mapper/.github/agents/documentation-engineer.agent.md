...
<!-- Vendored from plugins/codebase-mapper/agents/documentation-engineer.md in acaprino/claude-code-daodan, MIT. -->
...
- Use Grep to find references and map dependencies before using `#read/readFile` on entire files
...
- **Source of truth (internal):** import statements analyzed with `#search/textSearch` across the source tree.
...
**Accuracy:**
- All code references verified with `#read/readFile`
