...
<!-- Vendored from plugins/codebase-mapper/agents/doc-humanizer.md in acaprino/claude-code-daodan, MIT. -->
...
- Rewritten documents in-place (`#edit/editFiles`) or to specified output path
