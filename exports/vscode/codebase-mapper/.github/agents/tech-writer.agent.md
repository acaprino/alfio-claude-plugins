...
<!-- Vendored from plugins/codebase-mapper/agents/tech-writer.md in acaprino/claude-code-daodan, MIT. -->
...
**If `.codebase-map/_internal/interconnect.md` exists** (produced by the `xray-interconnect-mapper` agent in the `_pipelines` bundle in Phase 1b), read these anchors too:
