...
description: >
  ...
  Use when analyzing competitor apps, mapping app navigation, extracting design systems, or
  conducting UX audits on Android via ADB or on the web via Playwright MCP.
user-invocable: true
agents: []
---
