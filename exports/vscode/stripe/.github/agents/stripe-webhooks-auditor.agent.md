...
<!-- Vendored from plugins/stripe/agents/stripe-webhooks-auditor.md in acaprino/claude-code-daodan, MIT. -->
...
- `/audit-webhooks` -- slash command that invokes this agent with project defaults.
