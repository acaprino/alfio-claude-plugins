...
2. **Audit against the framework in Step 3.** It is the primary rubric for this command.
...
Use the ESLint output as ground truth.
...
Audit the React performance, state management, and bundle optimization of this frontend codebase against the framework below, using the context gathered in Steps 1 and 2.
...
When the audit is complete, create the `.react-review/` directory and write `report.md`.
