...
description: >
  Knowledge base for production question-answering pipelines. Use when building, optimizing, or
  auditing RAG systems, including Graph RAG, CRAG, Self-RAG, and Agentic RAG.
user-invocable: true
license: MIT
metadata:
  author: Alfio Caprino
  source: acaprino/claude-code-daodan
  upstream-plugin: rag-development
---
