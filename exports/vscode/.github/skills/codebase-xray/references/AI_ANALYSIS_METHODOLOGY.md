...
> This document defines how the agent should semantically analyze source code beyond mechanical AST extraction.
...
║  The AI extracts MEANING:    "Foo implements the Repository pattern for     ║
...
### Layer 2: HOW (Mechanical) - the agent's first pass
- Algorithm implementation details
- Data flow through functions
- State transformations

### Layer 3: WHY (Intent) - the agent's deep analysis
- Business purpose of the code
- Problem being solved
- Design decisions made

### Layer 4: WHEN (Temporal) - the agent's behavioral analysis
- Execution conditions and triggers
- Lifecycle and state transitions
- Concurrency and timing

### Layer 5: CONSEQUENCES (Impact) - the agent's systems thinking
...
When analyzing ANY code unit, the agent must answer these questions:
...
The agent should actively look for and document these issues:
...
| Script | Provides | The Agent Adds |
|--------|----------|-------------|
...
2. Use the agent to analyze semantics
3. Cross-reference script output with agent insights
