...
| **10 - Communication** | Protocol drift, missing heartbeat, timeout misconfiguration | Protocol-level issues outside CWE scope | Search for HTTP/gRPC client creation without timeout, missing DLQ config, heartbeat interval settings |
