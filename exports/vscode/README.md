...
|---|---|---|---|
| **`_pipelines`** | `/xray-team-analyze`, `/team-review`, `superpowers` | 18 / 31 / 2 | python, playwright-mcp (optional), `testing` and `typescript-development` bundles (optional) |
