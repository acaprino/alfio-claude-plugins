...
Invoke `/firefox-lint` first. If any blockers, stop.
...
- Scaffolding a new extension -> `/firefox-scaffold`
- Pre-submission lint -> `/firefox-lint`
- API / manifest / MDN lookups -> `firefox-extension-dev` agent
