...
3. Run `/firefox-publish` to sign + upload via AMO API
```
...
- Full API / manifest details -> `firefox-extension-dev` agent
- Pre-AMO publishing workflow -> `/firefox-publish`
- New extension scaffolding -> `/firefox-scaffold`
