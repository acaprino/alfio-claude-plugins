...
description: >
  End-to-end testing with Playwright and Cypress: reliable test suites that catch bugs, improve
  confidence, and enable fast deployment. Use when implementing E2E tests, debugging flaky tests,
  establishing testing standards, setting up Playwright or Cypress, or doing visual regression and
