...
name: tdd
description: >
  Test-driven development with the red-green-refactor loop, language-agnostic. Use when the user wants
  to build a feature or fix a bug test-first, mentions "red-green-refactor", wants integration tests, or
...
Source: Ported from mattpocock/skills (https://github.com/mattpocock/skills), `skills/engineering/tdd/`.
