...
<!-- Vendored from plugins/tauri-development/agents/tauri-desktop.md in acaprino/claude-code-daodan, MIT. -->
...
The deep content lives in the `tauri` skill's references. Load only what the task needs:
