...
> Arguments: `<project-name> [--type fastapi|django|library|cli|generic]`. Wherever `<arguments>` appears below, substitute the text the user typed after the prompt name.
