...
- **Always load:** `${PLUGIN_ROOT}/skills/defect-taxonomy/references/security.md` -- comprehensive vulnerability patterns with CWE mappings, detection strategies, code signatures
- **For API/distributed code:** also load `${PLUGIN_ROOT}/skills/defect-taxonomy/references/distributed-integration.md` -- API contract errors, protocol security, service mesh misconfig
- **For detection approach:** `${PLUGIN_ROOT}/skills/defect-taxonomy/references/detection-matrix.md` -- optimal detection channels per category
