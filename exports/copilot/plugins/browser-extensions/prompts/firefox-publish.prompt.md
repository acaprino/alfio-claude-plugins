...
> Arguments: `[path] [--channel listed|unlisted] [--version <semver>] [--dry-run]`. Wherever `<arguments>` appears below, substitute the text the user typed after the prompt name.
