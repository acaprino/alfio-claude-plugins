...
> Arguments: `<extension-name> [--mv V2|V3] [--sidebar] [--content-script] [--options-page]`. Wherever `<arguments>` appears below, substitute the text the user typed after the prompt name.
