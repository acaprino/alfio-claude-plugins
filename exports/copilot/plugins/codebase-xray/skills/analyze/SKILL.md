...
pip install -r "${PLUGIN_ROOT}/skills/analyze/scripts/requirements.txt"
# or
uv pip install -r "${PLUGIN_ROOT}/skills/analyze/scripts/requirements.txt"
```
...
All scripts live in `${PLUGIN_ROOT}/skills/analyze/scripts/`.

### 1. Analyze Single File

```bash
# Python
python "${PLUGIN_ROOT}/skills/analyze/scripts/analyze_file.py" \
...
```bash
python "${PLUGIN_ROOT}/skills/analyze/scripts/ast_parser.py" src/services/auth.ts
```
...
```bash
python "${PLUGIN_ROOT}/skills/analyze/scripts/doc_review.py" scan \
...
```bash
python "${PLUGIN_ROOT}/skills/analyze/scripts/doc_review.py" validate-links \
  --path docs/ --fix
```
...
```bash
python "${PLUGIN_ROOT}/skills/analyze/scripts/doc_review.py" verify \
...
```bash
python "${PLUGIN_ROOT}/skills/analyze/scripts/doc_review.py" update-indexes \
...
```bash
python "${PLUGIN_ROOT}/skills/analyze/scripts/doc_review.py" full-maintenance \
...
```bash
python "${PLUGIN_ROOT}/skills/analyze/scripts/rewrite_comments.py" analyze \
  src/main.py --report
```
...
```bash
python "${PLUGIN_ROOT}/skills/analyze/scripts/rewrite_comments.py" scan \
...
```bash
python "${PLUGIN_ROOT}/skills/analyze/scripts/rewrite_comments.py" report \
...
```bash
python "${PLUGIN_ROOT}/skills/analyze/scripts/rewrite_comments.py" rewrite \
...
```bash
python "${PLUGIN_ROOT}/skills/analyze/scripts/rewrite_comments.py" standards
```
