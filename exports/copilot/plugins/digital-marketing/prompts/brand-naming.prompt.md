...
> Arguments: `<brief description or industry> [--languages <lang1,lang2>] [--tlds <.com,.app,.io>]`. Wherever `<arguments>` appears below, substitute the text the user typed after the prompt name.
