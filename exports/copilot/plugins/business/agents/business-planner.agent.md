...
**Action Required:** Before asking questions, use the Read tool to load: `${PLUGIN_ROOT}/skills/saas-business-plan/references/market-sizing.md`
...
**Action Required:** Before asking questions, use the Read tool to load: `${PLUGIN_ROOT}/skills/saas-business-plan/references/audience-personas.md`
...
**Action Required:** Before asking questions, use the Read tool to load: `${PLUGIN_ROOT}/skills/saas-business-plan/references/competitive-analysis.md`
...
**Action Required:** Before asking questions, use the Read tool to load: `${PLUGIN_ROOT}/skills/saas-business-plan/references/positioning-pmf.md`
...
**Action Required:** Before asking questions, use the Read tool to load: `${PLUGIN_ROOT}/skills/saas-business-plan/references/pricing.md`
...
**Action Required:** Before asking questions, use the Read tool to load: `${PLUGIN_ROOT}/skills/saas-business-plan/references/go-to-market.md`
...
**Action Required:** Before asking questions, use the Read tool to load: `${PLUGIN_ROOT}/skills/saas-business-plan/references/advertising-metrics.md`

Also use the Read tool to load: `${PLUGIN_ROOT}/skills/saas-business-plan/references/tools-resources.md`
