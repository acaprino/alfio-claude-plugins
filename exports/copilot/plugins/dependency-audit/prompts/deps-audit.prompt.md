...
> Arguments: `[path] [--ecosystem=npm|python|rust|go|ruby|php|java|dotnet|all] [--security-only] [--license-check] [--update-pr]`. Wherever `<arguments>` appears below, substitute the text the user typed after the prompt name.
