---
description: >
  Edits documentation in place for a human reader.
  ...
  DO NOT TRIGGER WHEN: humanizing prose/articles (use /text-humanizer:humanize-text) or creating new docs (use /codebase-mapper:docs-create).
