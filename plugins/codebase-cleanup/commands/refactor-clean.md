...
description: >
  ...
  DO NOT TRIGGER WHEN: the task is Python-specific metrics-driven refactoring (use `/python-development:python-refactor`), pure readability cleanup with no structural changes (use `/clean-code:clean-code`), or dead-code/dependency removal (use `/senior-review:code-review --fix`).
