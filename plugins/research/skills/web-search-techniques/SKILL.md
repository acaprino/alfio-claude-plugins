...
| serper.dev (Google) | A key is available, or `--backend serper` | `python ${CLAUDE_PLUGIN_ROOT}/scripts/websearch.py "<query>" [--vertical search|news|scholar] [--num N] [--since h|d|w|m|y] [--gl CC] [--hl LANG] [--page P] [--json]` via Bash |
