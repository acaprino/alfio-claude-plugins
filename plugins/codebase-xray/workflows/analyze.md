...
The scripts in `${CLAUDE_PLUGIN_ROOT}/skills/xray-method/scripts/` are language-aware and support: **Python, Java, JavaScript, TypeScript (incl. TSX/JSX), SQL, PL/SQL, Rust**. You MUST use them instead of manual file reading whenever the target file matches one of those languages.
