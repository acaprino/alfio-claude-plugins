...
Use the language-aware scripts in `${CLAUDE_PLUGIN_ROOT}/skills/xray-method/scripts/` whenever the target language is supported (Python, Java, JavaScript, TypeScript, SQL, PL/SQL, Rust):
