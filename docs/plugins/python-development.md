...
**Related:** [senior-review](senior-review.md) (`/code-review --fix` uses the python-dead-code skill in its cleanup phases) | [clean-code](clean-code.md) (post-refactor code cleanup) | the upstream agent-teams `/agent-teams:team-feature` (wshobson/agents) for end-to-end development
