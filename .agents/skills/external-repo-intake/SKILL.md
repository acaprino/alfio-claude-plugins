...
Never add a sync-table row for anything listed under "Deliberately not vendored" in `AGENTS.md`. Those areas were handed back to their upstreams on purpose.
