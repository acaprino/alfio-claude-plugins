...
| **[ai-tooling](docs/plugins/ai-tooling.md)** | Prompt engineering knowledge base and optimization (reasoning patterns, output-shape enforcement down to small open models, extraction prompting, dated vendor guidance), Agent SDK | 1 | 2 | 1 |
