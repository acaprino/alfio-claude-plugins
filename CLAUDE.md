...
| `senior-review` | `agent-teams@claude-code-workflows`, `codebase-xray`, `abstraction-architect`, `react-development`, `platform-engineering`, `typescript-development`, `testing` |
